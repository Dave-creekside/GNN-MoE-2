...
Sweeps the 'learning_rate' hyperparameter for the GCL system.
...
SWEEP_VALUES = [1e-5, 5e-5, 1e-4, 3e-4, 5e-4, 1e-3]  # Values to test for learning_rate
...
for i, sweep_value in enumerate(SWEEP_VALUES):
    ...
    run_name_parts.append(f"lr{sweep_value:.0e}")
