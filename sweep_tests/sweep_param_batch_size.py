...
Sweeps the 'batch_size' hyperparameter for the GNN-MoE model.
"""
import subprocess
import csv
import os
...
SWEEP_VALUES = [32, 64, 128]  # Values to test for batch_size
...
baseline_config = {
    ...
    'num_layers': [4],
    'num_experts': [4],
    'batch_size': [64],  # This will be overridden by SWEEP_VALUES
    'learning_rate': [3e-4],
    'gnn_layers': [2],
    'dropout_rate': [0.1],
    'epochs': [10],
