...
Sweeps the 'batch_size' hyperparameter for the GCL system.
...
PARAMETER_BEING_SWEPT = "batch_size"
SWEEP_VALUES = [1, 2, 4, 8, 16, 32]  # Values to test for batch_size
...
baseline_config = {
    ...
    'num_layers': [4],
    'num_experts': [2],
    'batch_size': [2],  # This will be overridden by SWEEP_VALUES
    'learning_rate': [3e-4],
    'dropout_rate': [0.1],
    'epochs': [3],
...
for i, sweep_value in enumerate(SWEEP_VALUES):
    ...
    run_name_parts.append(f"bs{sweep_value}")
