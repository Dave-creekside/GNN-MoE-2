...
Sweeps the 'embed_dim' hyperparameter for the GCL system.
...
SWEEP_VALUES = [64, 128, 256, 384, 512]  # Values to test for embed_dim
...
baseline_config = {
    ...
    'embed_dim': [128],  # This will be overridden by SWEEP_VALUES
    'num_layers': [4],
    'num_experts': [2],
    'batch_size': [2],
    'learning_rate': [3e-4],
...
for i, sweep_value in enumerate(SWEEP_VALUES):
    ...
    run_name_parts.append(f"ed{sweep_value}")
