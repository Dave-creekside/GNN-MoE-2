...
Sweeps the 'num_experts' hyperparameter for the GCL system.
...
PARAMETER_BEING_SWEPT = "num_experts"
SWEEP_VALUES = [2, 4, 6, 8, 12, 16]  # Values to test for num_experts
...
baseline_config = {
    ...
    'embed_dim': [128],
    'num_layers': [4],
    'num_experts': [2],  # This will be overridden by SWEEP_VALUES
    'batch_size': [2],
    'learning_rate': [3e-4],
    'dropout_rate': [0.1],
    'epochs': [3],
...
for i, sweep_value in enumerate(SWEEP_VALUES):
    ...
    run_name_parts.append(f"ne{sweep_value}")
