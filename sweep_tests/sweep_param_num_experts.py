...
Sweeps the 'num_experts' hyperparameter for the GNN-MoE model.
"""
import subprocess
import csv
import os
...
SWEEP_VALUES = [2, 4, 8, 16]  # Values to test for num_experts

# Baseline values (used when a parameter is not being swept)
baseline_config = {
    'embed_dim': [384],
    'num_layers': [4],
    'num_experts': [4],  # This will be overridden by SWEEP_VALUES
    'batch_size': [64],
    'learning_rate': [3e-4],
    'gnn_layers': [2],
    'dropout_rate': [0.1],
